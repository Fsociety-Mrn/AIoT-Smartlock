...
class JoloRecognition:
    ...
    def __init__(self):
        ...
        self.Saved_Data = torch.load('/home/aiotsmartlock/Downloads/AIoT_Smartlock/Model/data.pt', map_location='cpu')
    ...
    def Face_Compare(self, face, threshold=0.75):
        try:
            return self.FaceCompare(face,threshold=threshold)
        except:
            return ('No match detected', None)
            
    def FaceCompare(self, face, threshold=0.75):
    ...
    def Face_Train(self, Dataset_Folder="/home/aiotsmartlock/Downloads/AIoT_Smartlock/Known_Faces", location="/home/aiotsmartlock/Downloads/AIoT_Smartlock/Model"):
        try:
